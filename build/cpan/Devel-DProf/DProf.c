 ...
 * contents of DProf.xs. Do not edit this file, edit DProf.xs instead.
 *
...
XS(XS_Devel__DProf_END); /* prototype to pass -Wmissing-prototypes */
...
XS(XS_Devel__DProf_NONESUCH); /* prototype to pass -Wmissing-prototypes */
XS(XS_Devel__DProf_NONESUCH)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
extern "C"
#endif
XS(boot_Devel__DProf); /* prototype to pass -Wmissing-prototypes */
XS(boot_Devel__DProf)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("Devel::DProf::END", XS_Devel__DProf_END, file);
        newXS("Devel::DProf::NONESUCH", XS_Devel__DProf_NONESUCH, file);
