...
XS(XS_Unicode__Normalize_decompose)
{
	...
	SV *	src = ST(0);
	SV *	compat;
#line 450 "Normalize.xs"
    SV* dst;
    U8 *s, *d, *dend;
    STRLEN slen, dlen;
#line 523 "Normalize.c"
	SV *	RETVAL;
...
#line 472 "Normalize.xs"
    ...
    U8 *s, *d, *dend;
    STRLEN slen, dlen;
#line 565 "Normalize.c"
	SV *	RETVAL;
#line 476 "Normalize.xs"
    s = (U8*)sv_2pvunicode(src,&slen);
    dst = newSVpvn("", 0);
    dlen = slen;
    New(0, d, dlen+1, U8);
...
XS(XS_Unicode__Normalize_compose)
{
    ...
    {
	SV *	src = ST(0);
#line 496 "Normalize.xs"
    SV* dst;
    U8 *s, *d, *dend;
    STRLEN slen, dlen;
#line 602 "Normalize.c"
	SV *	RETVAL;
#line 500 "Normalize.xs"
    s = (U8*)sv_2pvunicode(src,&slen);
    dst = newSVpvn("", 0);
    dlen = slen;
    New(0, d, dlen+1, U8);
...
XS(XS_Unicode__Normalize_NFD)
{
    ...
    {
	SV *	src = ST(0);
#line 520 "Normalize.xs"
    SV *dst;
    U8 *s, *t, *tend, *d, *dend;
    STRLEN slen, tlen, dlen;
#line 639 "Normalize.c"
	SV *	RETVAL;
#line 524 "Normalize.xs"
    s = (U8*)sv_2pvunicode(src,&slen);
...
XS(XS_Unicode__Normalize_NFC)
{
    ...
    {
	SV *	src = ST(0);
#line 560 "Normalize.xs"
    SV *dst;
    U8 *s, *t, *tend, *u, *uend, *d, *dend;
    STRLEN slen, tlen, ulen, dlen;
#line 691 "Normalize.c"
	SV *	RETVAL;
#line 564 "Normalize.xs"
    s = (U8*)sv_2pvunicode(src,&slen);
...
XS(XS_Unicode__Normalize_checkNFD)
{
    ...
    {
	SV *	src = ST(0);
#line 607 "Normalize.xs"
    STRLEN srclen, retlen;
    U8 *s, *e, *p, curCC, preCC;
    bool result = TRUE;
#line 751 "Normalize.c"
	SV *	RETVAL;
#line 611 "Normalize.xs"
...
XS(XS_Unicode__Normalize_checkNFC)
{
    ...
    {
	SV *	src = ST(0);
#line 643 "Normalize.xs"
    STRLEN srclen, retlen;
    U8 *s, *e, *p, curCC, preCC;
    bool result = TRUE;
    bool isMAYBE = FALSE;
#line 801 "Normalize.c"
	SV *	RETVAL;
#line 648 "Normalize.xs"
    s = (U8*)sv_2pvunicode(src,&srclen);
    e = s + srclen;
...
XS(XS_Unicode__Normalize_checkFCD)
{
    ...
    {
	SV *	src = ST(0);
#line 699 "Normalize.xs"
    STRLEN srclen, retlen;
    U8 *s, *e, *p, curCC, preCC;
    bool result = TRUE;
    bool isMAYBE = FALSE;
#line 870 "Normalize.c"
	SV *	RETVAL;
#line 704 "Normalize.xs"
    s = (U8*)sv_2pvunicode(src,&srclen);
    e = s + srclen;
    preCC = 0;
    for (p = s; p < e; p += retlen) {
...
#line 1066 "Normalize.c"
	SV *	RETVAL;
#line 806 "Normalize.xs"
    if (Hangul_IsS(uv) || (ix ? dec_compat(uv) : dec_canonical(uv)))
	result = TRUE; /* NFD_NO or NFKD_NO */
    RETVAL = boolSV(result);
#line 1072 "Normalize.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#line 821 "Normalize.xs"
    bool result = FALSE;
#line 1095 "Normalize.c"
	SV *	RETVAL;
#line 823 "Normalize.xs"
    if (isExclusion(uv) || isSingleton(uv) || isNonStDecomp(uv))
...
XS(XS_Unicode__Normalize_splitOnLastStarter)
{
    ...
    {
	SV *	src = ST(0);
#line 878 "Normalize.xs"
    SV *svp;
    STRLEN srclen;
    U8 *s, *e, *p;
#line 1197 "Normalize.c"
#line 882 "Normalize.xs"
    s = (U8*)sv_2pvunicode(src,&srclen);
    e = s + srclen;
    p = e;
    while (s < p) {
