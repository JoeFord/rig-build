...
XS(XS_threads_create); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_create)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_threads_list); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_list)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
XS(XS_threads_self); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_self)
{
#ifdef dVAR
    dVAR; dXSARGS;
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1174 "threads.xs"
        char *classname;
        ithread *thread;
#line 1275 "threads.c"
#line 1177 "threads.xs"
        /* Class method only */
...
XS(XS_threads_tid); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_tid)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
XS(XS_threads_join); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_join)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
XS(XS_threads_yield); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_yield)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
XS(XS_threads_detach); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_detach)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1336 "threads.xs"
        ithread *thread;
        int detach_err;
        dMY_POOL;
#line 1492 "threads.c"
#line 1340 "threads.xs"
        PERL_UNUSED_VAR(items);
...
XS(XS_threads_kill); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_kill)
{
#ifdef dVAR
    dVAR; dXSARGS;
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1384 "threads.xs"
        ithread *thread;
        char *sig_name;
        IV signal;
        int no_handler = 1;
#line 1554 "threads.c"
#line 1389 "threads.xs"
...
XS(XS_threads_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_DESTROY)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_threads_equal); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_equal)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
XS(XS_threads_object); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_object)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_threads__handle); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads__handle)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_threads_get_stack_size); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_get_stack_size)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1549 "threads.xs"
        IV stack_size;
        dMY_POOL;
#line 1781 "threads.c"
#line 1552 "threads.xs"
        PERL_UNUSED_VAR(items);
        if (sv_isobject(ST(0))) {
            /* $thr->get_stack_size() */
...
XS(XS_threads_set_stack_size); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_set_stack_size)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1568 "threads.xs"
        IV old_size;
        dMY_POOL;
#line 1813 "threads.c"
#line 1571 "threads.xs"
        if (items != 2) {
...
XS(XS_threads_is_running); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_is_running)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_threads_is_detached); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_is_detached)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_threads_is_joinable); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_is_joinable)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_threads_wantarray); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_wantarray)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_threads_set_thread_exit_only); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_set_thread_exit_only)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_threads_error); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_error)
{
#ifdef dVAR
    dVAR; dXSARGS;
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1670 "threads.xs"
        ithread *thread;
        SV *err = NULL;
#line 1993 "threads.c"
#line 1673 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
extern "C"
#endif
XS(boot_threads); /* prototype to pass -Wmissing-prototypes */
XS(boot_threads)
{
#ifdef dVAR
    dVAR; dXSARGS;
