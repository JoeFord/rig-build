...
XS(XS_Fcntl_AUTOLOAD); /* prototype to pass -Wmissing-prototypes */
XS(XS_Fcntl_AUTOLOAD)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Fcntl_S_IMODE); /* prototype to pass -Wmissing-prototypes */
XS(XS_Fcntl_S_IMODE)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
XS(XS_Fcntl_S_IFMT); /* prototype to pass -Wmissing-prototypes */
XS(XS_Fcntl_S_IFMT)
{
#ifdef dVAR
    dVAR; dXSARGS;
