...
#line 150 "attributes.c"

XS(XS_attributes__modify_attrs); /* prototype to pass -Wmissing-prototypes */
XS(XS_attributes__modify_attrs)
{
    ...
    SP -= items;
    {
#line 93 "attributes.xs"
    SV *rv, *sv;
#line 166 "attributes.c"
#line 96 "attributes.xs"
    if (items < 1) {
usage:
...
XS(XS_attributes__fetch_attrs); /* prototype to pass -Wmissing-prototypes */
XS(XS_attributes__fetch_attrs)
{
    ...
    SP -= items;
    {
#line 114 "attributes.xs"
    SV *rv, *sv;
    cv_flags_t cvflags;
#line 203 "attributes.c"
#line 117 "attributes.xs"
    if (items != 1) {
usage:
...
XS(XS_attributes__guess_stash); /* prototype to pass -Wmissing-prototypes */
...
#line 145 "attributes.xs"
    SV *rv, *sv;
    dXSTARG;
#line 250 "attributes.c"
#line 148 "attributes.xs"
    if (items != 1) {
usage:
	croak_xs_usage(cv, "$reference");
    }
...
XS(XS_attributes_reftype); /* prototype to pass -Wmissing-prototypes */
XS(XS_attributes_reftype)
{
    ...
    SP -= items;
    {
#line 192 "attributes.xs"
    SV *rv, *sv;
    dXSTARG;
#line 313 "attributes.c"
#line 195 "attributes.xs"
    if (items != 1) {
usage:
	croak_xs_usage(cv, "$reference");
    }
...
extern "C"
#endif
XS(boot_attributes); /* prototype to pass -Wmissing-prototypes */
XS(boot_attributes)
{
#ifdef dVAR
    dVAR; dXSARGS;
