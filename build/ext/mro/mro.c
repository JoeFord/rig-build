...
XS(XS_mro_get_linear_isa); /* prototype to pass -Wmissing-prototypes */
...
XS(XS_mro_set_mro); /* prototype to pass -Wmissing-prototypes */
XS(XS_mro_set_mro)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
XS(XS_mro_get_mro); /* prototype to pass -Wmissing-prototypes */
XS(XS_mro_get_mro)
{
#ifdef dVAR
    dVAR; dXSARGS;
...
XS(XS_mro_get_isarev); /* prototype to pass -Wmissing-prototypes */
...
XS(XS_mro_is_universal); /* prototype to pass -Wmissing-prototypes */
...
XS(XS_mro_invalidate_all_method_caches); /* prototype to pass -Wmissing-prototypes */
...
XS(XS_mro_get_pkg_gen); /* prototype to pass -Wmissing-prototypes */
